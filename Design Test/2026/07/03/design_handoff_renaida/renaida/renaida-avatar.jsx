/* global React */
// ─────────────────────────────────────────────────────────────────
// Renaida — avatar built from the Skåra mark.
// The carved notch (fals) becomes a single expressive eye.
// True to the logo path: disc r26 @ (32,32), square notch x32–46 / y18–32.
// Keyframes live in the host page (see Renaida.html <style>).
// ─────────────────────────────────────────────────────────────────
...
window.RenaidaAvatar = function RenaidaAvatar({
  size = 160,
  state = "idle",
  look = "center",
  headColor = "#2F5D4E",
