...
This folder contains eight HTML mockups + their JSX source + the brand pack. Open `index.html` for a guided tour, or jump into any individual file.
...
| 07 | `07-Rum-v2.html` | Rum (room editor) refresh: desktop list + drawer + mobil bottom-sheet, alla 14 sektioner från befintlig drawer fördelade på 7 tabs + alltid-synliga interna anteckningar | `src/components/floormap/RoomEditor.tsx`, `src/pages/Rooms.tsx` |
| 08 | `08-Rum-v2-Feature-parity.html` | Audit-rapport: visar vilka funktioner från befintlig Rum-vy som finns i v2 och var de bor | Granskningsdokument |
