...
// Mirrors prod weekdayLabel: the user names weekdays in their own language, so
// the date table must carry that name too; the model mistranslates otherwise
// ("på onsdag" resolved to a Monday, 2026-07-10).
function weekdayLabel(d, language) {
